            ...
            <li style="margin-bottom: 10px">
              ...
              <!-- ko if: dataset_type() == 'input_path' || dataset_type() == 'output_path' -->
                ...
                <span style="padding-left:100px">
                  ...
                  <span data-bind="visible: dataset_variable().length > 0">
                    ${ _('Will convert to') }
                    <a target="_blank" data-bind="text: convertVariables(dataset_variable(), same_start(), start(), same_frequency(), frequency_unit(), start_instance()), attr: {'href': '/filebrowser/view' + convertVariables(dataset_variable(), same_start(), start(), same_frequency(), frequency_unit(), start_instance())}"></a>
                  </span>
                  </a>
                </span>
...
<script type="text/javascript">
  ...
  function convertVariables(path, hasSameStart, customStart, hasSameFrequency, customFrequencyUnit, startInstance) {
