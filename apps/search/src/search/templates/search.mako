          ...
          <fieldset>
            ...
            <span data-bind="visible: $root.availableDateFields().length > 0">
              ...
              <div class="control-group" data-bind="visible: collection.timeFilter.type() == 'fixed'">
                ...
                <div class="controls">
                  <input id="settingstimestart" type="text" data-bind="value: collection.timeFilter.from" />
                </div>
              </div>
              <div class="control-group" data-bind="visible: collection.timeFilter.type() == 'fixed'">
                <label class="control-label" for="settingstimeend">${ _('End date/time') }</label>
                <div class="controls">
                  <input id="settingstimeend" type="text" data-bind="value: collection.timeFilter.to" />
                </div>
              </div>
              <div class="control-group">
                <div class="controls">
